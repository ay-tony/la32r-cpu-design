...
#
# Script generated by Vivado on Sun Jul 07 02:11:02 +0800 2024
...
#
# Usage        : DataRam.sh
#                DataRam.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DataRam.sh [-reset_run]
#                DataRam.sh [-reset_log]
#                DataRam.sh [-help]
#
...
#                script (type 'DataRam.sh -help' for more information).
#
...
# script info
echo -e "DataRam.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DataRam.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.DataRam xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.DataRam -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log DataRam_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: DataRam.sh [-step]\n\
Usage: DataRam.sh [-lib_map_path]\n\
Usage: DataRam.sh [-reset_run]\n\
Usage: DataRam.sh [-reset_log]\n\
Usage: DataRam.sh [-keep_index]\n\
