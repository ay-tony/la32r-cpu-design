...
#
# Script generated by Vivado on Mon Jul 08 06:39:55 +0800 2024
...
#
# Usage        : ClkPll.sh
#                ClkPll.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ClkPll.sh [-reset_run]
#                ClkPll.sh [-reset_log]
#                ClkPll.sh [-help]
#
...
#                script (type 'ClkPll.sh -help' for more information).
#
...
# script info
echo -e "ClkPll.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ClkPll.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ClkPll xil_defaultlib.glbl -o ClkPll_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ClkPll_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ClkPll_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ClkPll_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ClkPll.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ClkPll.sh [-help]\n\
Usage: ClkPll.sh [-step]\n\
Usage: ClkPll.sh [-lib_map_path]\n\
Usage: ClkPll.sh [-reset_run]\n\
Usage: ClkPll.sh [-reset_log]\n\
Usage: ClkPll.sh [-keep_index]\n\
Usage: ClkPll.sh [-noclean_files]\n\n\
