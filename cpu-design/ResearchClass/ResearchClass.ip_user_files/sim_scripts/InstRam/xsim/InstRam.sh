...
#
# Script generated by Vivado on Sun Jul 07 02:10:39 +0800 2024
...
#
# Usage        : InstRam.sh
#                InstRam.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                InstRam.sh [-reset_run]
#                InstRam.sh [-reset_log]
#                InstRam.sh [-help]
#
...
# script info
echo -e "InstRam.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./InstRam.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot InstRam xil_defaultlib.InstRam xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim InstRam -key {Behavioral:sim_1:Functional:InstRam} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb InstRam.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./InstRam.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: InstRam.sh [-help]\n\
Usage: InstRam.sh [-step]\n\
Usage: InstRam.sh [-lib_map_path]\n\
Usage: InstRam.sh [-reset_run]\n\
Usage: InstRam.sh [-reset_log]\n\
Usage: InstRam.sh [-keep_index]\n\
Usage: InstRam.sh [-noclean_files]\n\n\
